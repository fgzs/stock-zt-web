...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.H2("0", id='total-limit-up', className="card-title text-primary"),
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.H2("0%", id='avg-change', className="card-title text-danger"),
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.H2("0", id='avg-amount', className="card-title text-info"),
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.H2("0%", id='avg-turnover', className="card-title text-warning"),
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.H2("0", id='max-limit-days', className="card-title text-success"),
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.Button("🔄 更新", id="update-btn", n_clicks=0, className="btn btn-primary w-100"),
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    html.Div(id='limit-up-table-container', style={'maxHeight': '400px', 'overflowY': 'auto'})
                ])
            ])
        ], width=12),
    ], className="mb-4"),
        ...
        for _, row in display_df.iterrows():
            table_rows.append(
                html.Tr([
                    html.Td(row['code']),
                    html.Td(row['name']),
                    html.Td(row['change_percent'], style={'color': 'red', 'font-weight': 'bold'}),
                    html.Td(row['price']),
                    html.Td(row['amount']),
                    html.Td(row['turnover_rate']),
                    html.Td(f"{row['limit_days']}板"),
